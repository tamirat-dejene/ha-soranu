...
const file_test_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"test.proto\x12\x04test\"7\n" +
	"\vTestMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent2A\n" +
	"\vTestService\x122\n" +
	"\n" +
	"TestMethod\x12\x11.test.TestMessage\x1a\x11.test.TestMessageB\x10Z\x0e/testpb;testpbb\x06proto3"
...
var file_test_proto_depIdxs = []int32{
	0, // 0: test.TestService.TestMethod:input_type -> test.TestMessage
	0, // 1: test.TestService.TestMethod:output_type -> test.TestMessage
